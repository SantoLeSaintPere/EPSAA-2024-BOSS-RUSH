...
public abstract class BossQueenBaseState : State
{
    protected BossQueenStateMachine stateMachine;

    protected BossQueenBaseState(BossQueenStateMachine stateMachine)
    {
    ...
    protected void CheckHealth()
    {
        ...
        {
            stateMachine.NextState(new BossQueenDeathState(stateMachine));
        }
    }
    #region CHASING
    ...
    {
        stateMachine.attackManager.attackCounter = Random.Range(0, 2);
    ...
    protected void Attack(BossAttacks attacks)
    {
        ...
        {
            stateMachine.NextState(new BossQueenChasingState(stateMachine));
        }
    }
